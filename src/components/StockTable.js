  ...
  return (
    <div className="stockTable">
      <div className="product">
        <div className="stick1" style={{ background: color }} />&nbsp;{productPredict.name}&nbsp;재고
        준비량
      </div>
      <hr />
      <div className="roww">
        <div className="stick3" style={{ background: color }} />
        <div className="table">
          <table border="0">
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                {productPredict.value.map(v => {
                  return (
                    <td>
                      {Math.round(v * 1.1 * 100) / 100.0}
                    </td>
                  );
                })}
              </tr>
